...
// Holders badge component
const HoldersBadge = memo(function HoldersBadge({
  holders,
}: {
  holders: number
}) {
  // Determine badge style based on holder count
              ...
              tokens.map((token, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Holders */}
                    <td className="py-4 px-4">
                      <HoldersBadge holders={token.holders || 0} />
                    </td>
